        ...
        return [
            ...
            new MonitoringProvider(
                ...
                metrics: [
                    ...
                    new MetricDefinition(id: 'mock.cf.bandwidth', label: 'Bandwidth', description: 'Total bandwidth', namespace: 'Cloudflare/Analytics', metricName: 'bandwidth', unit: 'Bytes', stat: 'Sum', dimensions: ['ZoneId' => 'mock-zone'], locked: true),
                    new MetricDefinition(id: 'mock.cf.cached_bandwidth', label: 'Cached Bandwidth', description: 'Bandwidth served from cache', namespace: 'Cloudflare/Analytics', metricName: 'cachedBandwidth', unit: 'Bytes', stat: 'Sum', dimensions: ['ZoneId' => 'mock-zone'], locked: true),
                    new MetricDefinition(id: 'mock.cf.encrypted_requests', label: 'SSL Requests', description: 'HTTPS requests', namespace: 'Cloudflare/Analytics', metricName: 'encryptedRequests', unit: 'Count', stat: 'Sum', dimensions: ['ZoneId' => 'mock-zone'], locked: true),
                    new MetricDefinition(id: 'mock.cf.encrypted_bandwidth', label: 'SSL Bandwidth', description: 'HTTPS bandwidth', namespace: 'Cloudflare/Analytics', metricName: 'encryptedBandwidth', unit: 'Bytes', stat: 'Sum', dimensions: ['ZoneId' => 'mock-zone'], locked: true),
