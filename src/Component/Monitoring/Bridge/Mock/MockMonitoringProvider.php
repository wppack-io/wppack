        ...
        return [
            ...
            new MonitoringProvider(
                ...
                metrics: [
                    ...
                    new MetricDefinition(id: 'mock.cf.encrypted', label: 'SSL Requests', description: 'HTTPS requests', namespace: 'Cloudflare/Analytics', metricName: 'encryptedRequests', unit: 'Count', stat: 'Sum', dimensions: ['ZoneId' => 'mock-zone'], locked: true),
