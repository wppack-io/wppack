...
use WPPack\Component\Database\Bridge\PostgreSQL\PostgreSQLDriverFactory;
use WPPack\Component\Dsn\Dsn;

final class PostgreSQLDriverFactoryTest extends TestCase
{
    #[Test]
    ...
    public function createsDriver(): void
    {
        ...
        self::assertInstanceOf(PostgreSQLDriver::class, $driver);
    ...
    {
        $defs = PostgreSQLDriverFactory::definitions();
    ...
    {
        $reflection = new \ReflectionClass(PostgreSQLDriver::class);
