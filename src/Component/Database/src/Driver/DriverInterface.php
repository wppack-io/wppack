...
interface DriverInterface
{
    ...
    /**
     * Return the auto-increment / sequence value generated by the most recent
     * INSERT on this driver.
     *
     * The return type is `int`, which on 64-bit PHP (every supported runtime
     * since 7.x) safely represents a MySQL BIGINT UNSIGNED up to 2^63-1. In
     * the unusual event of hitting a sequence value above that ceiling the
     * driver will throw rather than silently wrap to a negative int —
     * production instances of WordPress sit comfortably below this bound,
     * so the tradeoff keeps the public API ergonomically typed.
     */
