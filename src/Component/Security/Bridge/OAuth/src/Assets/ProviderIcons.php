 ...
 *
 * Provider logos are sourced from official brand resources:
 * - Google: developers.google.com (Sign in with Google branding guidelines)
 * - Microsoft: learn.microsoft.com (Microsoft identity platform branding)
 * - Entra ID: learn.microsoft.com (Microsoft Entra branding)
 * - GitHub: github.githubassets.com (GitHub Brand guidelines)
 * - Discord: discord.com (Discord Brand guidelines)
 * - Apple: developer.apple.com (Sign in with Apple guidelines)
 * - X: about.x.com (X Brand Toolkit)
 * - Keycloak: keycloak.org (Apache License 2.0)
 * - Cognito: AWS Architecture Icons (AWS trademark guidelines)
 * - OneLogin: onelogin.com/press-kit (OneLogin Press Kit)
 * - Okta: companieslogo.com
 * - Auth0: brandfetch.com/auth0.com
 * - Slack: brandfetch.com/slack.com (Slack Brand guidelines)
 * - LINE: brandfetch.com/line.me (LINE Brand guidelines)
 * - Facebook: brandfetch.com/facebook.com (Meta Brand guidelines)
 * - OpenID: Simple Icons (CC0 1.0 Universal, https://simpleicons.org)
 *
...
final class ProviderIcons
{
    ...
    private const ICONS = [
        'google' => '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M19.6 10.227c0-.709-.064-1.39-.182-2.045H10v3.868h5.382c-.232 1.25-.936 2.31-1.996 3.018v2.51h3.232C18.509 15.836 19.6 13.273 19.6 10.227z" fill="#4285F4"/><path d="M10 20c2.7 0 4.964-.895 6.618-2.423l-3.232-2.509c-.895.6-2.04.955-3.386.955-2.605 0-4.81-1.76-5.596-4.123H1.064v2.59C2.709 17.76 6.09 20 10 20z" fill="#34A853"/><path d="M4.404 11.9c-.2-.6-.314-1.241-.314-1.9s.114-1.3.314-1.9V5.509H1.064A9.996 9.996 0 000 10c0 1.614.386 3.14 1.064 4.49L4.404 11.9z" fill="#FBBC04"/><path d="M10 3.977c1.468 0 2.786.505 3.823 1.496l2.868-2.868C14.959.99 12.695 0 10 0 6.09 0 2.71 2.24 1.064 5.509L4.404 8.1C5.19 5.736 7.395 3.977 10 3.977z" fill="#E94235"/></svg>',
        ...
        'discord' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="-3 -15.39 133.14 127.14"><defs><style>.cls-1{fill:#5865f2;}</style></defs><g id="图层_2" data-name="图层 2"><g id="Discord_Logos" data-name="Discord Logos"><g id="Discord_Logo_-_Large_-_White" data-name="Discord Logo - Large - White"><path class="cls-1" d="M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.7,77.7,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a68.68,68.68,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1A105.25,105.25,0,0,0,126.6,80.22h0C129.24,52.84,122.09,29.11,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53s5-12.74,11.43-12.74S54,46,53.89,53,48.84,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.25,60,73.25,53s5-12.74,11.44-12.74S96.23,46,96.12,53,91.08,65.69,84.69,65.69Z"/></g></g></g></svg>',
        ...
        'onelogin' => '<svg version="1.1" id="Logomark_black" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="105 105 237 237" enable-background="new 0 0 446.7 445.6" xml:space="preserve"> <g> <path fill="currentColor" d="M223.3,111.8C161.9,111.8,112,161.6,112,223c0,61.5,49.8,111.3,111.3,111.3S334.6,284.5,334.6,223 C334.6,161.6,284.8,111.8,223.3,111.8z"/> <path fill="#FFFFFF" d="M239.9,262.4c0,2.1-1.1,3.2-3.2,3.2h-20c-2.1,0-3.2-1.1-3.2-3.2v-48.2h-15.3c-2.1,0-3.2-1.1-3.2-3.2v-20 c0-2.1,1.1-3.2,3.2-3.2h39c2.1,0,2.6,1.1,2.6,2.6V262.4z"/> </g> </svg>',
        ...
        'auth0' => '<svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 52.6 64" style="enable-background:new 0 0 52.6 64;" xml:space="preserve"> <metadata> <sfw xmlns="ns_sfw;"> <slices> </slices> <sliceSourceBounds bottomLeftOrigin="true" height="64" width="52.6" x="0" y="39.6"> </sliceSourceBounds> </sfw> </metadata> <g> <path d="M3.4,27.8c10.5-1.7,18.7-10.4,20.4-20.9l0.6-5C24.5,1,24-0.1,22.9,0C15,0.6,7.6,3.2,3.4,4.9C1.3,5.8,0,7.8,0,10v16.5 c0,1,0.9,1.7,1.8,1.6L3.4,27.8L3.4,27.8z"> </path> <path d="M28.8,6.9c1.7,10.5,9.9,19.2,20.4,20.9l1.5,0.3c1,0.2,1.8-0.6,1.8-1.6V10c0-2.2-1.3-4.2-3.4-5.1C45,3.2,37.6,0.6,29.7,0 c-1-0.1-1.5,1-1.4,1.8L28.8,6.9L28.8,6.9z"> </path> <path d="M49.2,32.4c-14.3,2.8-21,12.4-21,30.4c0,0.9,0.9,1.5,1.7,1c6.6-4.4,21.1-16.1,22.6-30.6C52.5,31.4,50.3,32.3,49.2,32.4z"> </path> <path d="M3.4,32.4c14.3,2.8,21,12.4,21,30.4c0,0.9-0.9,1.5-1.7,1C16.1,59.4,1.6,47.8,0.1,33.2C0.1,31.4,2.3,32.3,3.4,32.4z"> </path> </g> </svg>',
        'slack' => '<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="93 93 84 84" style="enable-background:new 0 0 270 270;" xml:space="preserve"> <style type="text/css"> .st0{fill:#E01E5A;} .st1{fill:#36C5F0;} .st2{fill:#2EB67D;} .st3{fill:#ECB22E;} </style> <g> <g> <path class="st0" d="M99.4,151.2c0,7.1-5.8,12.9-12.9,12.9c-7.1,0-12.9-5.8-12.9-12.9c0-7.1,5.8-12.9,12.9-12.9h12.9V151.2z"> </path> <path class="st0" d="M105.9,151.2c0-7.1,5.8-12.9,12.9-12.9s12.9,5.8,12.9,12.9v32.3c0,7.1-5.8,12.9-12.9,12.9 s-12.9-5.8-12.9-12.9V151.2z"> </path> </g> <g> <path class="st1" d="M118.8,99.4c-7.1,0-12.9-5.8-12.9-12.9c0-7.1,5.8-12.9,12.9-12.9s12.9,5.8,12.9,12.9v12.9H118.8z"> </path> <path class="st1" d="M118.8,105.9c7.1,0,12.9,5.8,12.9,12.9s-5.8,12.9-12.9,12.9H86.5c-7.1,0-12.9-5.8-12.9-12.9 s5.8-12.9,12.9-12.9H118.8z"> </path> </g> <g> <path class="st2" d="M170.6,118.8c0-7.1,5.8-12.9,12.9-12.9c7.1,0,12.9,5.8,12.9,12.9s-5.8,12.9-12.9,12.9h-12.9V118.8z"> </path> <path class="st2" d="M164.1,118.8c0,7.1-5.8,12.9-12.9,12.9c-7.1,0-12.9-5.8-12.9-12.9V86.5c0-7.1,5.8-12.9,12.9-12.9 c7.1,0,12.9,5.8,12.9,12.9V118.8z"> </path> </g> <g> <path class="st3" d="M151.2,170.6c7.1,0,12.9,5.8,12.9,12.9c0,7.1-5.8,12.9-12.9,12.9c-7.1,0-12.9-5.8-12.9-12.9v-12.9H151.2z"> </path> <path class="st3" d="M151.2,164.1c-7.1,0-12.9-5.8-12.9-12.9c0-7.1,5.8-12.9,12.9-12.9h32.3c7.1,0,12.9,5.8,12.9,12.9 c0,7.1-5.8,12.9-12.9,12.9H151.2z"> </path> </g> </g> </svg>',
        'line' => '<svg version="1.1" id="Layer_1" xmlns:x="ns_extend;" xmlns:i="ns_ai;" xmlns:graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55 55" style="enable-background:new 0 0 55 55;" xml:space="preserve"> <style type="text/css"> .st0{fill:#06C755;} .st1{fill:#FFFFFF;} </style> <metadata> <sfw xmlns="ns_sfw;"> <slices> </slices> <sliceSourceBounds bottomLeftOrigin="true" height="55" width="55" x="175.5" y="-224.6"> </sliceSourceBounds> <optimizationSettings> <targetSettings fileFormat="JPEGFormat" targetSettingsID="0"> <JPEGFormat blurAmount="0" embedICCProfile="false" matteColor="#FFFFFF" noMatteColor="false" optimized="true" progressive="false" quality="60"> </JPEGFormat> </targetSettings> </optimizationSettings> </sfw> </metadata> <g> <path class="st0" d="M42.6,55H12.4C5.6,55,0,49.4,0,42.6V12.4C0,5.6,5.6,0,12.4,0h30.2C49.4,0,55,5.6,55,12.4v30.2 C55,49.4,49.4,55,42.6,55z"> </path> <g> <g> <g> <path class="st1" d="M45.8,24.9c0-8.2-8.2-14.9-18.3-14.9C17.4,10,9.2,16.7,9.2,24.9c0,7.4,6.5,13.5,15.3,14.7 c0.6,0.1,1.4,0.4,1.6,0.9c0.2,0.5,0.1,1.2,0.1,1.7c0,0-0.2,1.3-0.3,1.6c-0.1,0.5-0.4,1.8,1.6,1c2-0.8,10.6-6.2,14.4-10.6h0 C44.6,31.2,45.8,28.2,45.8,24.9z"> </path> </g> <g> <path class="st0" d="M39.7,29.6h-5.1h0c-0.2,0-0.4-0.2-0.4-0.4v0v0v-8v0v0c0-0.2,0.2-0.4,0.4-0.4h0h5.1c0.2,0,0.4,0.2,0.4,0.4 v1.3c0,0.2-0.2,0.4-0.4,0.4h-3.5v1.4h3.5c0.2,0,0.4,0.2,0.4,0.4v1.3c0,0.2-0.2,0.4-0.4,0.4h-3.5v1.4h3.5c0.2,0,0.4,0.2,0.4,0.4 v1.3C40.1,29.5,39.9,29.6,39.7,29.6z"> </path> <path class="st0" d="M20.7,29.6c0.2,0,0.4-0.2,0.4-0.4V28c0-0.2-0.2-0.4-0.4-0.4h-3.5v-6.4c0-0.2-0.2-0.4-0.4-0.4h-1.3 c-0.2,0-0.4,0.2-0.4,0.4v8v0v0c0,0.2,0.2,0.4,0.4,0.4h0H20.7z"> </path> <path class="st0" d="M23.8,20.9h-1.3c-0.2,0-0.4,0.2-0.4,0.4v8c0,0.2,0.2,0.4,0.4,0.4h1.3c0.2,0,0.4-0.2,0.4-0.4v-8 C24.1,21.1,24,20.9,23.8,20.9z"> </path> <path class="st0" d="M32.6,20.9h-1.3c-0.2,0-0.4,0.2-0.4,0.4V26l-3.7-4.9c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0 c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0 c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0h-1.3c-0.2,0-0.4,0.2-0.4,0.4v8c0,0.2,0.2,0.4,0.4,0.4H27 c0.2,0,0.4-0.2,0.4-0.4v-4.8l3.7,5c0,0,0.1,0.1,0.1,0.1c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0 c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0,0,0,0c0,0,0.1,0,0.1,0h1.3c0.2,0,0.4-0.2,0.4-0.4v-8C33,21.1,32.8,20.9,32.6,20.9z"> </path> </g> </g> </g> </g> </svg>',
    ...
    private const STYLES = [
        ...
        // Facebook: brand, dark, light
        'facebook' => [
            'brand' => ['label' => 'Brand', 'bg' => '#1877F2', 'text' => '#FFFFFF', 'border' => '#1877F2', 'icon' => '#FFFFFF'],
            'dark' => ['label' => 'Dark', 'bg' => '#1E1E1E', 'text' => '#FFFFFF', 'border' => '#1E1E1E', 'icon' => '#1877F2'],
            'light' => ['label' => 'Light', 'bg' => '#FFFFFF', 'text' => '#1E1E1E', 'border' => '#DADCE0', 'icon' => '#1877F2'],
        ],
        // GitHub: dark, light
        'github' => [
        ...
        // LINE: green only (per LINE brand guidelines)
        'line' => [
            'green' => ['label' => 'Green', 'bg' => '#06C755', 'text' => '#FFFFFF', 'border' => '#06C755', 'icon' => '#FFFFFF', 'hover' => '#05b34c'],
        ],
