...
final class ProviderIcons
{
    ...
    private const ICONS = [
        'amazon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 262"><path fill="#F90" fill-rule="nonzero" d="M221.5 210.3c-105.2 50.1-170.5 8.2-212.4-17.3-2.6-1.6-7 .4-3.2 4.8 13.9 16.9 59.6 57.6 119.2 57.6 59.6 0 95.1-32.5 99.5-38.2 4.4-5.6 1.3-8.7-3.2-6.9zm29.6-16.3c-2.8-3.7-17.2-4.4-26.2-3.3-9.1 1.1-22.6 6.6-21.5 9.9.6 1.3 1.8.7 8.1.1 6.2-.6 23.7-2.8 27.3 1.9 3.7 4.8-5.6 27.6-7.3 31.3-1.6 3.7.6 4.6 3.7 2.2 3-2.5 8.5-8.8 12.1-17.8 3.6-9 5.9-21.6 3.7-24.4z"/><path fill="currentColor" fill-rule="evenodd" d="M184.8 190.3c-2.2 2-5.5 2.1-8 .8-11.2-9.3-13.2-13.6-19.4-22.5-18.5 18.9-31.6 24.5-55.6 24.5-28.4 0-50.5-17.5-50.5-52.6 0-27.4 14.9-46 36-55.1 18.3-8.1 43.9-9.5 63.4-11.7v-4.4c0-8 .6-17.5-4.1-24.4-4.1-6.2-12-8.8-18.9-8.8-12.9 0-24.3 6.6-27.1 20.3-.6 3-2.8 6-5.8 6.2l-32.7-3.5c-2.8-.6-5.8-2.8-5-7.1C64.8 12.4 100.6.4 132.7.4c16.4 0 37.9 4.4 50.8 16.8 16.4 15.3 14.8 35.8 14.8 58v52.6c0 15.8 6.5 22.7 12.7 31.3 2.2 3 2.7 6.7-.1 9-6.9 5.7-19.1 16.4-25.9 22.4l-.1-.1zM150.7 108.1c0 13.1.3 24.1-6.3 35.8-5.4 9.5-13.9 15.3-23.3 15.3-13 0-20.5-9.9-20.5-24.4 0-28.8 25.8-34 50.1-34v7.3z"/></svg>',
        ...
        'facebook' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 5.884 4.203 10.788 9.75 11.808v-8.29H6.84v-3.518h2.91V9.41c0-2.912 1.712-4.52 4.334-4.52 1.255 0 2.569.227 2.569.227v2.86h-1.447c-1.425 0-1.869.896-1.869 1.816v2.28h3.18l-.508 3.518h-2.672v8.29C19.797 22.86 24 17.957 24 12.072z"/></svg>',
    ...
    private const STYLES = [
        'amazon' => [
            'light' => ['label' => 'ライト', 'bg' => '#FFFFFF', 'text' => '#1E1E1E', 'border' => '#DADCE0', 'icon' => '#232F3E'],
            'dark' => ['label' => 'ダーク', 'bg' => '#232F3E', 'text' => '#FFFFFF', 'border' => '#232F3E', 'icon' => '#FFFFFF'],
        ],
        'apple' => [
        ...
        'facebook' => [
            'light' => ['label' => 'ライト', 'bg' => '#FFFFFF', 'text' => '#1E1E1E', 'border' => '#DADCE0', 'icon' => '#0866FF'],
            'brand' => ['label' => 'ブランド', 'bg' => '#0866FF', 'text' => '#FFFFFF', 'border' => '#0866FF', 'icon' => '#FFFFFF'],
            'dark' => ['label' => 'ダーク', 'bg' => '#1E1E1E', 'text' => '#FFFFFF', 'border' => '#1E1E1E', 'icon' => '#0866FF'],
        ],
        'github' => [
