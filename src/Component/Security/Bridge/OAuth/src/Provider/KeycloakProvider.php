 ...
 *
 * Requires a Keycloak base URL and realm name (e.g., "https://keycloak.example.com" + "myrealm").
 * Combined as domain: "keycloak.example.com/realms/myrealm"
 */
final class KeycloakProvider implements ProviderInterface
{
    ...
    public function getAuthorizationUrl(
        ...
        $endpoint = $this->discoveryDocument?->getAuthorizationEndpoint()
            ...
            ?? \sprintf('https://%s/protocol/openid-connect/auth', $this->domain);
    ...
    public function getTokenEndpoint(): string
    {
        return $this->discoveryDocument?->getTokenEndpoint()
            ...
            ?? \sprintf('https://%s/protocol/openid-connect/token', $this->domain);
    }
    ...
    public function getUserInfoEndpoint(): string
    {
        return $this->discoveryDocument?->getUserinfoEndpoint()
            ...
            ?? \sprintf('https://%s/protocol/openid-connect/userinfo', $this->domain);
    }
    ...
    public function getJwksUri(): string
    {
        return $this->discoveryDocument?->getJwksUri()
            ...
            ?? \sprintf('https://%s/protocol/openid-connect/certs', $this->domain);
    }
    ...
    public function getEndSessionEndpoint(): string
    {
        return $this->discoveryDocument?->getEndSessionEndpoint()
            ...
            ?? \sprintf('https://%s/protocol/openid-connect/logout', $this->domain);
    }
