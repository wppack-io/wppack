 ...
 * Okta OIDC provider.
 *
 * Requires an Okta domain (e.g., "dev-123456.okta.com").
 */
final class OktaProvider implements ProviderInterface
{
    ...
    public function getAuthorizationUrl(
        ...
        $endpoint = $this->discoveryDocument?->getAuthorizationEndpoint()
            ...
            ?? \sprintf('https://%s/oauth2/default/v1/authorize', $this->domain);
    ...
    public function getTokenEndpoint(): string
    {
        return $this->discoveryDocument?->getTokenEndpoint()
            ...
            ?? \sprintf('https://%s/oauth2/default/v1/token', $this->domain);
    }
    ...
    public function getUserInfoEndpoint(): string
    {
        return $this->discoveryDocument?->getUserinfoEndpoint()
            ...
            ?? \sprintf('https://%s/oauth2/default/v1/userinfo', $this->domain);
    }
    ...
    public function getJwksUri(): string
    {
        return $this->discoveryDocument?->getJwksUri()
            ...
            ?? \sprintf('https://%s/oauth2/default/v1/keys', $this->domain);
    }
    ...
    public function getIssuer(): string
    {
        return $this->discoveryDocument?->getIssuer()
            ...
            ?? \sprintf('https://%s/oauth2/default', $this->domain);
    }
    ...
    public function getEndSessionEndpoint(): string
    {
        return $this->discoveryDocument?->getEndSessionEndpoint()
            ...
            ?? \sprintf('https://%s/oauth2/default/v1/logout', $this->domain);
    }
