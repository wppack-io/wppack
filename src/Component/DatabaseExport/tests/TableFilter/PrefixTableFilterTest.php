...
final class PrefixTableFilterTest extends TestCase
{
    ...
    {
        $filter = new PrefixTableFilter('wp_', new ExportConfiguration());
    ...
    {
        $filter = new PrefixTableFilter('wp_', new ExportConfiguration(blogIds: [1]));
    ...
    {
        $filter = new PrefixTableFilter('wp_', new ExportConfiguration(blogIds: [2]));
    ...
    {
        $filter = new PrefixTableFilter('wp_', new ExportConfiguration(blogIds: [1, 3]));
