        ...
        return [
            ...
            [
                ...
                'metrics' => [
                    ...
                    ['metricName' => 'ACUUtilization', 'label' => 'ACU Utilization', 'description' => 'ACU usage percentage (Serverless)', 'stat' => 'Average', 'unit' => 'Percent'],
                    ['metricName' => 'VolumeBytesUsed', 'label' => 'Storage Used', 'description' => 'Cluster storage volume size', 'stat' => 'Average', 'unit' => 'Bytes'],
                    ['metricName' => 'AuroraReplicaLag', 'label' => 'Replica Lag', 'description' => 'PostgreSQL replica lag', 'stat' => 'Average', 'unit' => 'Milliseconds'],
                    ['metricName' => 'MaximumUsedTransactionIDs', 'label' => 'Max Used TXIDs', 'description' => 'Transaction ID wraparound risk', 'stat' => 'Maximum', 'unit' => 'Count'],
                ],
            ],
            [
                'id' => 'dsql-cluster',
                ...
                'metrics' => [
                    ['metricName' => 'ReadDPU', 'label' => 'Read DPU', 'description' => 'DPU consumed by read operations', 'stat' => 'Sum', 'unit' => 'Count'],
                    ['metricName' => 'WriteDPU', 'label' => 'Write DPU', 'description' => 'DPU consumed by write operations', 'stat' => 'Sum', 'unit' => 'Count'],
                    ['metricName' => 'ComputeDPU', 'label' => 'Compute DPU', 'description' => 'DPU consumed by compute operations', 'stat' => 'Sum', 'unit' => 'Count'],
                    ['metricName' => 'TotalDPU', 'label' => 'Total DPU', 'description' => 'Total DPU consumed', 'stat' => 'Sum', 'unit' => 'Count'],
                ],
            ],
            [
                'id' => 'elasticache',
