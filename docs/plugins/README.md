...
| [wppack/passkey-login-plugin](./passkey-login-plugin.md) | WebAuthn/Passkey パスワードレスログイン | wppack/passkey-security, wppack/security |
| [wppack/monitoring-plugin](./monitoring-plugin.md) | インフラモニタリングダッシュボード | wppack/monitoring, wppack/cloudwatch-monitoring |
| [wppack/role-provisioning-plugin](./role-provisioning-plugin.md) | ルールベースのロール割当・ブログ所属管理 | wppack/admin, wppack/rest, wppack/role, wppack/site |
