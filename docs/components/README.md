...
| [DependencyInjection](./dependency-injection.md) | `wppack/dependency-injection` | PSR-11 準拠のサービスコンテナ、オートワイヤリング |
| [Config](./config.md) | `wppack/config` | 型安全な設定管理、環境変数・WordPress options 統合 |
| [EventDispatcher](./event-dispatcher.md) | `wppack/event-dispatcher` | PSR-14 準拠のイベントシステム |
| Filesystem | `wppack/filesystem` | ファイル操作抽象化、ストリーム対応 |
