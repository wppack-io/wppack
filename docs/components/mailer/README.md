...
```php
final class PhpMailer extends \PHPMailer\PHPMailer\PHPMailer
{
...
abstract class AbstractTransport implements TransportInterface
{
    ...
    public function configure(PhpMailer $phpMailer): void
    {
        $phpMailer->registerCustomMailer($this->getMailerName(), fn(PhpMailer $m): bool => ...);
...
| `PhpMailer` | 拡張 PHPMailer（カスタムメーラー登録） |
